...
import { faEnvelope, faGlobe, faCar } from "@fortawesome/free-solid-svg-icons";
...
export default function ProfilePage() {
  ...
  return (
    <>
      <div className="title mx-2 mt-2 mb-2">My Profile</div>
      <div className="mx-3">
        {isUpdated && (
          ...
          <div className="control">
            <div className="select">
              <select onChange={(e) => setState(e.target.value)} value={state}>
                ...
                {/* Removed the 'selected' attribute for accessibility */}
        ...
        <div className="flex justify-center">
          <RadarChart captions={captions} data={radardata} size={400} />
        </div>
        ...
        <div className="field is-grouped mb-20">
          <div className="control">
            <button className="button is-primary" onClick={updateUserProfile}>
              Update Profile
            </button>
          </div>
          <div className="control">
